...
const Services = () => {
  return (
    <section
      id="services"
      className="relative w-full min-h-screen px-4 py-50 bg-no-repeat bg-cover bg-dblue"
      style={{
    ...
    >
      <div className="relative z-10 flex flex-col items-center space-y-10">
        ...
        <div className="flex flex-wrap flex-col service:flex-row items-center justify-center gap-5 w-full max-w-7xl">
          {servicesList.slice(0, 3).map((service, index) => (
            <motion.a
              ...
              className="hover:shadow-md hover:shadow-gold group flex flex-col bg-dblue rounded-2xl overflow-hidden shadow-lg shadow-gray-300 transition-shadow duration-300 
                         w-full lg:w-[33%] max-w-lg service:max-w-xs"
        ...
        <div className="flex flex-wrap flex-col service:flex-row items-center justify-center gap-5 w-full max-w-6xl">
          {servicesList.slice(3, 5).map((service, index) => (
            ...
            >
              ...
              <div className="p-8 flex flex-col gap-3 text-white">
                <h1 className="text-xl sm:text-2xl font-h1">{service.name}</h1>
                <p className="text-gray-300/80 font-p text-sm sm:text-base leading-relaxed">
                  {service.text}
                </p>
