...
const Welcome = () => {
  ...
  return (
    <div className="flex flex-col pt-25 md:pt-45 space-y-5 h-[75dvh] w-full lg:px-4">
<div className="flex flex-col items-start justify-center gap-3 text-gray-300 w-full">
  <div className="flex flex-col md:flex-row md:items-center md:gap-2">
    ...
    <h3 className="text-md md:text-lg font-h3">
      junto a ti en cada trayecto
    </h3>
  </div>

  <h2 className="text-4xl md:text-4xl font-h3 font-bold max-w-6xl">
