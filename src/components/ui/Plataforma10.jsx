...
import { HiArrowPath, HiArrowUturnRight } from "react-icons/hi2"
...
const Plataforma10 = () => {
    ...
    useEffect(() => {
        ...
        script.onerror = () => {
            console.error("No se pudo cargar el widget de Plataforma 10")
        }
            ...
            <div className="h-full w-full flex items-center justify-center">
                {widgetLoaded ? (
                    ...
                    <div className="flex items-center justify-center w-full h-[400px]">
                        <HiArrowPath className="animate-spin text-gray-500 text-5xl" />
                    </div>
                )}
            </div>
        </div>
